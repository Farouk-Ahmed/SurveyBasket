...
namespace SurveyBasket.Migrations
{
    ...
    [Migration("20260308015549_AddClientEntity")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SurveyBasket.Entities.AppUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("SurveyBasket.Entities.Client", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("SurveyBasket.Entities.AppUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("SurveyBasket.Entities.AppUser", b =>
                {
                    b.OwnsMany("SurveyBasket.Entities.RefrechTokens", "RefrechTokens", b1 =>
                        {
                            ...
                            b1.Property<DateTime>("CreeatedOn")
                                .HasColumnType("datetime2");
            ...
            modelBuilder.Entity("SurveyBasket.Entities.Attachment", b =>
                {
                    b.HasOne("SurveyBasket.Entities.Client", "Client")
            ...
            modelBuilder.Entity("SurveyBasket.Entities.Client", b =>
                {
                    b.HasOne("SurveyBasket.Entities.AppUser", "AppUser")
                        .WithOne()
                        .HasForeignKey("SurveyBasket.Entities.Client", "AppUserId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("SurveyBasket.Entities.AppUser", "CreatedBy")
                        .WithMany()
                        .HasForeignKey("CreatedById")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("SurveyBasket.Entities.AppUser", "DeletedBy")
                        .WithMany()
                        .HasForeignKey("DeletedById")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("SurveyBasket.Entities.AppUser", "UpdatedBy")
                        .WithMany()
